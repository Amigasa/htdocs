    ...
    <div class="card">
      <h3>Мои заявки</h3>
        ...
        <div class="requests-list">
          <div v-for="r in requests" :key="r.id" class="request-item" @click="viewRequestDetails(r.id)">
...
export default {
  ...
  setup() {
    ...
    function viewRequestDetails(id) { router.push(`/client/requests/${id}`); }
    return { requests, load, getStatusColor, getStatusText, viewRequestDetails };
  }
};
</script>
